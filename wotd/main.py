...
# Setting up logging
logging.basicConfig(filename="wotd_jps.log", level=logging.INFO, format='%(asctime)s - %(message)s')
...
def extract_data():
    ...
    try:
        ...
        # Content extraction
        word = soup.select_one("#wotd-widget > div.r101-wotd-widget__section--first > div.r101-wotd-widget__word-row > div.r101-wotd-widget__word").text.strip()
        audio_element = soup.select_one("#wotd-widget > div.r101-wotd-widget__section--first > div.r101-wotd-widget__word-row > div.r101-wotd-widget__audio.r101-audio-player--a.js-audio-player")
        audio_url = audio_element['data-audio'] if audio_element and 'data-audio' in audio_element.attrs else None
        date = soup.select_one("#wotd-widget > div.r101-wotd-widget__header > div > button.r101-wotd-widget__date-picker.js-wotd-widget-picker").text.strip()
        yomigana = soup.select_one("#wotd-widget > div.r101-wotd-widget__section--first > div.r101-wotd-widget__additional-row > div.r101-wotd-widget__additional-field.kana").text.strip()
        romaji = soup.select_one("#wotd-widget > div.r101-wotd-widget__section--first > div.r101-wotd-widget__additional-row > div.r101-wotd-widget__additional-field.romaji").text.strip()
        ...
        example1_mp3 = example1_elem['data-audio'] if example1_elem and 'data-audio' in example1_elem.attrs else None
...
def download_word_audio(audio_url, filename):
    ...
    try:
        ...
        logging.error(f"IO error (disk issues, maybe out of space or permission denied): {e}")
